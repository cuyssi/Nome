...
import { GetTaskLocationMessage } from "./GetTaskLocationMessage";
    ...
    return (
        <Modal isOpen={!!task}>
            <div className="relative bg-white rounded-2xl shadow-lg p-10 max-w-md w-full">
                <div className="flex items-center justify-center text-lg font-semibold text-gray-800 mt-6">
                ...
                <div className="flex items-center justify-center ">
                    <div className="mt-4 text-gray-600 font-semibold">
                        <p className="text-gray-600 semibold mt-2">Tu tarea:</p>
                        <p className="italic font-medium text-gray-400">“{task.text}”</p>
                        <p className="text-gray-600 semibold mt-2">
                            Se ha guardado en:
                            <br></br> {GetTaskLocationMessage(task)}
                        </p>
                    </div>
                </div>
