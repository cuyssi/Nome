...
export const Tasks_list = ({ tasks = [], openModalWithTask, className = "" }) => {
    ...
    return (
        <div
            className={`flex flex-col gap-8 items-center w-full h-[90%] hide-scrollbar overflow-y-auto px-2 pb-[20rem] cursor-grab touch-pan-x touch-pan-y select-none ${className}`}
            style={{
