    ...
    <div className="flex w-full justify-center items-center p-2">
      <Container innerClass="justify-between" outerClass="w-[100%]">
        <Link to="./completed" className="flex-1 flex-col p-2 no-underline items-center">
          <p className="text-yellow-200 font-extrabold text-center drop-shadow-[0_0_1px_black] text-2xl">
            {completedTodayCount}
          </p>
        ...
        <Link to="./today" className="flex-1 flex-col p-2 no-underline justify-center items-center">
          <p className="text-purple-400 text-center font-extrabold drop-shadow-[0_0_1px_black] text-2xl">
            {totalTodayCount}
          </p>
