...
import { BagItemsModal } from "./BagItemsModal";

export const Bag_card = ({ bag, onDelete }) => {
    ...
    const {
        ...
        color,
    } = useTaskCard(bag, isSchoolBag ? () => {} : onDelete, handleSwipeEdit, editBag);
            ...
            <div className="relative w-full min-h-[6rem] overflow-hidden rounded-xl">
                ...
                >
                    <Container_Card outerClass={`${color.bg}`} innerClass={`${color.border}`}>
                        <div className="flex flex-col justify-center items-start px-4 w-full">
